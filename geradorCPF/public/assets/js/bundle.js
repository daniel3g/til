...
(function () {
  ...
  var cpfGerado = document.querySelector('.build-cpf');
...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    key: "formataCPF",
    value: function formataCPF(novoCPF) {
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function criaDigito(cpfParcial) {
      ...
      var cpfSoma = cpfArray.map(function (valor, indice) {
        return Number(valor) * (regressivo - indice);
      }).reduce(function (somatoria, valor) {
        return somatoria + valor;
      });
      var digito = 11 - cpfSoma % 11;
